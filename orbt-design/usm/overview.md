...
* Composability: full [ERC-4626](architecture.md#core-vault-layer-erc-4626) compatibility integrates with DeFi protocols
...
[s0xAsset](../../user-flow-and-guides/how-to-buy-s0xasset.md) tokens are ERC-20 claims on a growing pool of underlying 0x assets. Users can enter/exit (subject to delays) and shares appreciate via the global interest rate.
