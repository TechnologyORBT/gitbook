...
* **Tenor controls:** Allowances with [**time locks**](../../allocator/governance-and-policy-layer-setup.md#id-5.3-timelock) and **auto-expiry** (e.g., 30–120 minutes) for rapid settlement loops.
