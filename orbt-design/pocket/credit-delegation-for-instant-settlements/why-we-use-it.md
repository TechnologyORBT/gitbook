...
* **Latency:** The delegate can borrow and settle **in one transaction -** ideal for [**intent-based settlement**](../../../introduction/intent-based-settlements.md) **networks** (e.g., RFQ/solver systems).
