...
1. Allocators mint 0xUSD via credit lines (no redemption-rate effect at issuance) to build inventory and sell externally above $1, then later repay with supported stablecoins (paying borrowFeeBps). `Profit = market premium − financing costs`.
...
2. Allocators buy back 0xUSD at a discount, reduce reservedOx, and/or repay their debt with stablecoins. → Circulating 0xUSD shrinks; price lifts toward $1.
