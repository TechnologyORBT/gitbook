...
Users or allocators deposit supported collateral (e.g., USDC, WBTC) into the UCE.
{% endstep %}

{% step %}
#### **Minting Synthetic Assets:**

Based on collateral ratios or credit limits, the UCE issues 0xAssets (like 0xUSD or 0xBTC) directly to PSM allowing users to swap the assets directly
{% endstep %}

{% step %}
#### **Active Liquidity Management**

All the underlying assets are deployed into **money markets** or **vaults** to earn yield while maintaining instant redemption ratios.
{% endstep %}

{% step %}
#### **Redemptions & Peg Stability**

When users redeem, the UCE settles instantly from its on-hand reserves. If reserves dip, it dynamically pulls liquidity from connected pockets — ensuring peg consistency without delays.
{% endstep %}
