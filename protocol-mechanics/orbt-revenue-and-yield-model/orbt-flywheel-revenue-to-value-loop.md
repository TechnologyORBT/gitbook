...
ORBT employs a **flywheel model** to reinforce the value of its token and incentivize long-term participation.\
The term _“flywheel”_ refers to a **positive feedback loop** where success compounds - aligning all stakeholders around growth and sustainability.

For ORBT, the flywheel can be summarized as:

<mark style="background-color:yellow;">**Revenue Generation → Yield Distribution → ORBT Buyback & Burn → ORBT Staking Rewards (and Governance)**</mark> <mark style="background-color:yellow;"></mark><mark style="background-color:yellow;">→ which attracts more users and liquidity → generating more revenue - and the cycle continues.</mark>

### 1. Revenue Generation

As detailed earlier, **ORBT collects revenues** from multiple sources such as fees, profit shares, and yield.\
All revenues initially accumulate in the **protocol’s treasury** (or sub-treasuries).
...
ORBT’s **first obligation** is to its users, particularly [**0xUSD**](../../orbt-design/0xusd/) **holders** and liquidity providers.\
To maintain attractiveness, ORBT may pay **savings yields** or **ORBTMM deposit yields** funded from real revenue, not inflationary emissions.

#### Example:

If the target [savings rate](../savings-rate.md) for 0xUSD is **7%**, and total 0xUSD locked in savings contracts equals **100M**, then:
...
{% hint style="info" %}
This mirrors MakerDAO’s Endgame model, where surplus income funds the DAI (USDS) Savings Rate.\
ORBT adopts the same principle: using **real yield** to keep demand high and liquidity sticky.
{% endhint %}

In short:

<mark style="background-color:yellow;">**Revenue → Yield**</mark> <mark style="background-color:yellow;"></mark><mark style="background-color:yellow;">is</mark> <mark style="background-color:yellow;"></mark><mark style="background-color:yellow;">**Step 1 of the Flywheel**</mark>\
Sustained yield keeps users engaged, increases 0xUSD demand, and ensures capital remains within ORBT’s ecosystem to generate even more revenue.
...
In parallel (or subsequent) to buybacks, ORBT rewards those who actively participate in governance by **staking their ORBT** in the [**User Savings Module**](../../orbt-design/usm/) **(USM)**.

#### Possible Reward Structures

1. **Redistribution of Bought-Back ORBT**
   1. Some of the ORBT purchased during buybacks could be **redistributed to stakers** instead of burned, acting as a direct dividend in ORBT.
   2. However, since the design emphasizes burning, this redistribution is likely secondary.
2. **Revenue-Based Staking Rewards**
   1. A portion of **protocol revenue** (e.g., 0xUSD or ETH) is allocated to a **staking reward pool**.
   2. Stakers claim proportional shares of this pool, receiving income in stable assets.
...
<mark style="background-color:yellow;">More users and liquidity → more revenue → stronger buybacks and rewards → higher token value → and the cycle reinforces itself.</mark>

### 7. The Flywheel in Motion

<mark style="background-color:yellow;">Revenue → Users/Stakers → Higher Value → More Users/Liquidity → More Revenue</mark>
...
* Governance can adjust parameters like [**savings rate**](../savings-rate.md) or **fee structures** to maintain balance and prevent overextension.

#### Sustainability Principle:

ORBT’s payouts are **backed by real economic activity**, not inflationary emissions.\
This ensures that every yield, buyback, and burn event reflects genuine protocol profitability.
...
<table><thead><tr><th width="126.20001220703125">Quarter</th><th width="126.933349609375">Revenue</th><th width="205.73333740234375">Use of Funds</th><th>Results</th></tr></thead><tbody><tr><td><strong>Q1</strong></td><td>$5M</td><td>→ $1M to 0xUSD savings (users)<br>→ $2M for ORBT buyback (burned ~100M ORBT)<br>→ $1M for staker rewards<br>→ $1M retained</td><td>ORBT price rises; staking APY attractive; stablecoin yield sustained.</td></tr><tr><td><strong>Q2</strong></td><td>$8M</td><td>More user participation, more buybacks, larger reward pools.</td><td>Reinforced trust and compounding growth.</td></tr></tbody></table>
...
1. Real revenue funds real yield.
2. Yield locks user capital and trust.
3. Buybacks and burns strengthen ORBT value.
4. Staking rewards incentivize governance alignment.
5. Reinforcement attracts new users and liquidity.

The result:\
A **sustainable, deflationary, and community-driven growth cycle,** powered by real cash flows and transparent governance.
