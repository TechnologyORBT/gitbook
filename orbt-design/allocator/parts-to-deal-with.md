...
* Minting: `allocatorCreditMint(allocator, amount)` mints [0xAssets](../0xassets.md) into [UCE](../uce/), credits the allocator’s `reservedZeroX`, and increases their effective debt (tracked as `baseDebt × debtIndex`).
* Debt accounting:
