...
The redemption rate is applicable when users swap from 0xUSD to underlying. It is not applied when users go from underlying to 0xUSD (in that case, `tin` fee is applicable).
