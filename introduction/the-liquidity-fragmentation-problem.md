...
Pre-funded settlements let ORBT unify fragmented rails behind [0xAssets](../orbt-design/0xassets.md), creating a single, chain-agnostic experience layer.\
By monetizing in-transit capital and cycling it back within blocks, ORBT delivers real, on-chain yield to [s0xAsset](../user-flow-and-guides/how-to-buy-s0xasset.md) holders while defending a 1:1 peg.
