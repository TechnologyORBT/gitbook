...
### 1. Defining a Filler Execution Strategy <a href="#id-1-defining-a-filler-execution-strategy" id="id-1-defining-a-filler-execution-strategy"></a>
...
### 2A. Retrieve & Execute Signed Dutch Orders <a href="#id-2a-retrieve--execute-signed-dutch-orders" id="id-2a-retrieve--execute-signed-dutch-orders"></a>
...
### 2B. Retrieve & Execute Signed Limit Orders <a href="#id-2b-retrieve--execute-signed-limit-orders" id="id-2b-retrieve--execute-signed-limit-orders"></a>
